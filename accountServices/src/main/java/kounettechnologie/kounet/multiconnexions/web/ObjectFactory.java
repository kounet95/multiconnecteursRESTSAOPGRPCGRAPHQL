 ...
 * generated in the kounettechnologie.kounet.multiconnexions.web package. 
...
public class ObjectFactory {
    ...
    private final static QName _CustomerById_QNAME = new QName("http://web.multiconnexions.kounet.kounettechnologie/", "customerById");
    private final static QName _CustomerByIdResponse_QNAME = new QName("http://web.multiconnexions.kounet.kounettechnologie/", "customerByIdResponse");
    private final static QName _CustomerList_QNAME = new QName("http://web.multiconnexions.kounet.kounettechnologie/", "customerList");
    private final static QName _CustomerListResponse_QNAME = new QName("http://web.multiconnexions.kounet.kounettechnologie/", "customerListResponse");
    private final static QName _SaveCustomer_QNAME = new QName("http://web.multiconnexions.kounet.kounettechnologie/", "saveCustomer");
    private final static QName _SaveCustomerResponse_QNAME = new QName("http://web.multiconnexions.kounet.kounettechnologie/", "saveCustomerResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: kounettechnologie.kounet.multiconnexions.web
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://web.multiconnexions.kounet.kounettechnologie/", name = "customerById")
     ...
     */
    @XmlElementDecl(namespace = "http://web.multiconnexions.kounet.kounettechnologie/", name = "customerByIdResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.multiconnexions.kounet.kounettechnologie/", name = "customerList")
     ...
     */
    @XmlElementDecl(namespace = "http://web.multiconnexions.kounet.kounettechnologie/", name = "customerListResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.multiconnexions.kounet.kounettechnologie/", name = "saveCustomer")
     ...
     */
    @XmlElementDecl(namespace = "http://web.multiconnexions.kounet.kounettechnologie/", name = "saveCustomerResponse")
